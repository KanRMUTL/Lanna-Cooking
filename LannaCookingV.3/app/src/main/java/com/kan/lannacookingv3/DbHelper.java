...
public class DbHelper extends SQLiteOpenHelper {
    private static final String databaseName = "LannaCooking_29_08_2559.sqlte";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        SQLText = "INSERT INTO cooking (id, name, information, item, step,trick, img)" +
                ...
                "เคล็ดลับในการเลือกส่วนผสม\n" + "การเลือกเนื้อไก่ ควรเลือกน่องและสะโพก สำหรับข้าวซอยเนื้อ ควรใช้เนื้อสันคอ','ksk.jpg');";
        db.execSQL(SQLText);
        ...
        SQLText = "INSERT INTO cooking (id, name, information, item, step,trick, img)" +
                "VALUES ('010', 'ข้าวจี่', " +
                "'เข้าจี่ นับเป็นของกินเล่นอย่างหนึ่ง จัดได้อยู่ในประแภทอาหารที่มีวิธีการทำแบบปิ้งหรือย่าง สมัยก่อนนิยมใช้ข้าวเย็นหรือข้าวที่เหลือจากการกินมื้อเย็นวันก่อนมาปั้น" +
                " เอาไม้เสียบตรงกลาง และนำไปปิ้งกับถ่านไฟแดง เมื่อผิวของก้อนข้าวเกรียมเล็กน้อย ก็ถือว่าข้าวจี่นั้นใช้ได้แล้ว ปกติใช้เป็นอาหารสำหรับเด็กๆ " +
                "ที่ตื่นแต่เช้าพร้อมแม่ ช่วยแก้หิวในขณะที่นึ่งข้าวยังไม่สุก ถ้าจะให้มีรสชาติดีขึ้น ให้นำกระทิผสมเกลือ" +
                " คลุกกับข้าว ปั้นข้าวและเสียบไม้ นำไปปิ้งให้เกรียมนิดหน่อย จึงนำมาชุบไข่ แล้วนำไปปิ้งอีกที', " +
                "'1.\tข้าวนึ่ง\t500\tกรัม\n" + "2.\tกะทิ\t1/2\tถ้วย\n" +
                "3.\tไข่ไก่\t2\tฟอง\n" + "4.\tเกลือ\t1/2\tช้อนชา'," +
        ...
        SQLText = "INSERT INTO cooking (id, name, information, item, step,trick, img)" +
                ...
                "เคล็ดลับในการเลือกส่วนผสม\n" +
                "ปลีตาลต้องอ่อน ใหม่ และสด จะทำให้น้ำแกงมีรสหวาน" +
                "','kpt.jpg');";
